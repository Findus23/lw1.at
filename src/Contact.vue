		...
		<a rel="me noopener" href="https://video.lw1.at/accounts/lukas/videos" target="_blank"
		   :aria-label="peertubeText" data-balloon-pos="up">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="2799 -911 16 22" width="16" height="22">
				...
				<path d="M2799-910.7v10.7l8-5.3M2799-900v10.7l8-5.4M2807-905.3v10.6l8-5.3" fill="currentColor"></path>
...
export default Vue.extend({
    ...
    computed: {
        ...
        matrixText(): string {
            return this.english ? "Contact me via matrix.org (element.io)" : "Kontaktiere mich über matrix.org (element.io)";
        },
